...
{var x=t.realIndex,y=t.parentNode.realRIndex,s='';var changed=false;$('td.'+settings.clickClass).each(function()
{if($(this).parent('tr').get(0)==jQuery(e.target).parent('tr').get(0))
{$(this).parent('tr').children('td').removeClass(settings.clickClass);changed=true;return false;}
else
